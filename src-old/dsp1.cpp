...
static void DSP1_Op1B (void)
{
	...
	Log_Message("     MX: %d MY: %d MZ: %d Scale: %d", (int16) (mul<100>(DSP1.matrixB[0][0])), (int16) (mul<100>(DSP1.matrixB[0][1])), (int16) (mul<100>(DSP1.matrixB[0][2])), (int16) (mul<100>(DSP1.Op1BS)));
#endif
}

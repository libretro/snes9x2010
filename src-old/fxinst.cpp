...
#define	BRA_COND(cond) \
	...
	R15++; \
	FETCHPIPE; \
   int32_t condition = cond; \
   int32_t mask = (condition | -condition) >> 31; \
   int32_t result = ((GSU.avReg[15] + SEX8(v)) & mask) | ((GSU.avReg[15] + 1) & ~mask); \
   GSU.avReg[15] = result;
...
*/
   //branchless
   a[0] = isel_if(c & 0x01,a[0] | v, a[0] & ~v);
...
*/
   //branchless
   a[1] = isel_if(c & 0x02,a[1] | v, a[1] & ~v);
}
...
*/
   //branchless
   a[0x00] = isel_if(c & 0x01,a[0x00] | v, a[0x00] & ~v);
...
*/
   //branchless
   a[0x01] = isel_if(c & 0x02,a[0x01] | v, a[0x01] & ~v);
...
*/
   //branchless
   a[0x10] = isel_if(c & 0x04,a[0x10] | v, a[0x10] & ~v);
...
*/
   //branchless
   a[0x11] = isel_if(c & 0x08,a[0x11] | v, a[0x11] & ~v);
}
...
*/
   //branchless
   a[0x00] = isel_if(c & 0x01,a[0] | v,a[0] & ~v);
   //isel_if(a[0x00],c & 0x01,a[0] | v,a[0] & ~v);
...
*/
   //branchless
   a[0x01] = isel_if(c & 0x02,a[0x01] | v, a[0x01] & ~v);
   //isel_if(a[0x01], c & 0x04,a[0x10] | v, a[0x10] & ~v);
...
*/
   //branchless
   a[0x10] = isel_if(c & 0x04,a[0x10] | v, a[0x10] & ~v);
   //isel_if(a[0x10], c & 0x04,a[0x10] | v, a[0x10] & ~v);
...
*/
   //branchless
   a[0x11] = isel_if(c & 0x08,a[0x11] | v, a[0x11] & ~v);
   //isel_if(a[0x11], c & 0x08,a[0x11] | v, a[0x11] & ~v);
...
*/
   //branchless
   a[0x20] = isel_if(c & 0x10,a[0x20] | v, a[0x20] & ~v);
...
*/
   //branchless
   a[0x21] = isel_if(c & 0x20,a[0x21] | v, a[0x21] & ~v);
...
*/
   //branchless
   a[0x30] = isel_if(c & 0x40,a[0x30] | v, a[0x30] & ~v);
...
*/
   //branchless
   a[0x31] = isel_if(c & 0x080,a[0x31] | v, a[0x31] & ~v);
}
...
static void fx_div2 (void)
{
   ...
   //ghetto inline isel
   int32 s_cond = (s == -1);
   int32_t mask = (s_cond | -s_cond) >> 31;
   int32_t result = (0 & mask) | (((uint32) (s >> 1)) & ~mask);
   v = result;
   //end of ghetto inline isel

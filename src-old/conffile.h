...
class ConfigFile {
  public:
    ...
    void LoadFile_freader(fReader *r, const char *name=NULL);
    //void LoadFile_unzreader(unzReader *r, const char *name=NULL);
    ...
    bool SaveTo(const char *filename, bool no_sections = 0);

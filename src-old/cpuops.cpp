...
static void Op69M0 (void)
{
   ...
   //hardcode this
   uint16 Work16 = Immediate16(READ);
	if (CheckDecimal())
	{
		...
		//SetZN(Registers.A.W);
      //hardcode this
	   ICPU._Zero = Registers.A.W != 0;
	   ICPU._Negative = (uint8) (Registers.A.W >> 8);
      //end of hardcode
...
//mOPC(06Slow, Memory, DirectSlow, WRAP_BANK, ASL)
static void Op06Slow (void)
{
   if (CheckMemory())
...
static void Op16E0M1 (void)
{
   ASL8(DirectIndexedXE0(MODIFY));
}

mOP16(16E0M0,   DirectIndexedXE0,                 WRAP_BANK, ASL)
//mOPC(16Slow, Memory, DirectIndexedXSlow, WRAP_BANK, ASL)
static void Op16Slow (void)
{
   if (CheckMemory())
...
//mOPC(0ESlow, Memory, AbsoluteSlow, WRAP_NONE, ASL)
static void Op0ESlow (void)
{
   if (CheckMemory())
...
static void Op1EM1X0 (void)
{
   ASL8(AbsoluteIndexedXX0(MODIFY));
}

mOP16(1EM0X0,   AbsoluteIndexedXX0,               WRAP_NONE, ASL)
//mOPC(1ESlow, Memory, AbsoluteIndexedXSlow, WRAP_NONE, ASL)
static void Op1ESlow (void)
{
   if (CheckMemory())
...
//mOPC(C6Slow, Memory, DirectSlow, WRAP_BANK, DEC)

static void OpC6Slow (void)
{
   if (CheckMemory())
...
//mOPC(D6Slow, Memory, DirectIndexedXSlow, WRAP_BANK, DEC)

static void OpD6Slow (void)
{
   if (CheckMemory())
...
//mOPC(CESlow, Memory, AbsoluteSlow, WRAP_NONE, DEC)
static void OpCESlow (void)
{
   if (CheckMemory())
...
static void OpDEM1X0 (void)
{
   DEC8(AbsoluteIndexedXX0(MODIFY));
}

mOP16(DEM0X0,   AbsoluteIndexedXX0,               WRAP_NONE, DEC)
//mOPC(DESlow, Memory, AbsoluteIndexedXSlow, WRAP_NONE, DEC)

static void OpDESlow (void)
{
   if (CheckMemory())
...
//mOPC(E6Slow, Memory, DirectSlow, WRAP_BANK, INC)

static void OpE6Slow (void)
{
   if (CheckMemory())
...
//mOPC(EESlow, Memory, AbsoluteSlow, WRAP_NONE, INC)

static void OpEESlow (void)
{
   if (CheckMemory())
...
static void OpFEM1X0 (void)
{
   INC8(AbsoluteIndexedXX0(MODIFY));
}

mOP16(FEM0X0,   AbsoluteIndexedXX0,               WRAP_NONE, INC)
//mOPC(FESlow, Memory, AbsoluteIndexedXSlow, WRAP_NONE, INC)
static void OpFESlow (void)
{
   if (CheckMemory())
...
//mOPC(46Slow, Memory, DirectSlow, WRAP_BANK, LSR)
static void Op46Slow (void)
{
   if (CheckMemory())
...
//mOPC(56Slow, Memory, DirectIndexedXSlow, WRAP_BANK, LSR)

static void Op56Slow (void)
{
   if (CheckMemory())
...
//mOPC(4ESlow, Memory, AbsoluteSlow, WRAP_NONE, LSR)

static void Op4ESlow (void)
{
   if (CheckMemory())
...
static void Op5EM1X0 (void)
{
   LSR8(AbsoluteIndexedXX0(MODIFY));
}

mOP16(5EM0X0,   AbsoluteIndexedXX0,               WRAP_NONE, LSR)
//mOPC(5ESlow, Memory, AbsoluteIndexedXSlow, WRAP_NONE, LSR)

static void Op5ESlow (void)
{
   if (CheckMemory())
...
//mOPC(26Slow, Memory, DirectSlow, WRAP_BANK, ROL)

static void Op26Slow (void)
{
   if (CheckMemory())
...
static void Op36E0M1 (void)
{
   ROL8(DirectIndexedXE0(MODIFY));
}

mOP16(36E0M0,   DirectIndexedXE0,                 WRAP_BANK, ROL)
//mOPC(36Slow, Memory, DirectIndexedXSlow, WRAP_BANK, ROL)

static void Op36Slow (void)
{
   if (CheckMemory())
...
//mOPC(2ESlow, Memory, AbsoluteSlow, WRAP_NONE, ROL)

static void Op2ESlow (void)
{
   if (CheckMemory())
...
static void Op3EM1X0 (void)
{
   ROL8(AbsoluteIndexedXX0(MODIFY));
}

mOP16(3EM0X0,   AbsoluteIndexedXX0,               WRAP_NONE, ROL)
//mOPC(3ESlow, Memory, AbsoluteIndexedXSlow, WRAP_NONE, ROL)

static void Op3ESlow (void)
{
   if (CheckMemory())
...
//mOPC(66Slow, Memory, DirectSlow, WRAP_BANK, ROR)

static void Op66Slow (void)
{
   if (CheckMemory())
...
//mOPC(76Slow, Memory, DirectIndexedXSlow, WRAP_BANK, ROR)
static void Op76Slow (void)
{
   if (CheckMemory())
...
//mOPC(6ESlow, Memory, AbsoluteSlow, WRAP_NONE, ROR)
static void Op6ESlow (void)
{
   if (CheckMemory())
...
static void Op7EM1X0 (void)
{
   ROR8(AbsoluteIndexedXX0(MODIFY));
}

mOP16(7EM0X0,   AbsoluteIndexedXX0,               WRAP_NONE, ROR)
//mOPC(7ESlow, Memory, AbsoluteIndexedXSlow, WRAP_NONE, ROR)
static void Op7ESlow (void)
{
   if (CheckMemory())
...
//mOPC(14Slow, Memory, DirectSlow, WRAP_BANK, TRB)
static void Op14Slow (void)
{
   if (CheckMemory())
...
//mOPC(1CSlow, Memory, AbsoluteSlow, WRAP_BANK, TRB)
static void Op1CSlow (void)
{
   if (CheckMemory())
...
//mOPC(04Slow, Memory, DirectSlow, WRAP_BANK, TSB)
static void Op04Slow (void)
{
   if (CheckMemory())
...
//mOPC(0CSlow, Memory, AbsoluteSlow, WRAP_BANK, TSB)
static void Op0CSlow (void)
{
   if (CheckMemory())

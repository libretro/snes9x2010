...
void S9xSetController (int port, int controller, int8 id1, int8 id2, int8 id3, int8 id4); // port=0-1
...
//void S9xApplyCommand (s9xcommand_t cmd, uint64_t data1, int16 data2);
...
void S9xMovieUpdate_addFrameTrue();
void S9xMovieUpdate_addFrameFalse();
